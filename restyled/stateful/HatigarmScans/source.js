...
},{"./GenkanParser":30,"paperback-extensions-common":4}],29:[function(require,module,exports){
"use strict";
var __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.GenkanLegacy = void 0;
const Genkan_1 = require("./Genkan");
class GenkanLegacy extends Genkan_1.Genkan {
    searchRequest(query, metadata) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            // If we're supplied a page that we should be on, set our internal reference to that page. Otherwise, we start from page 1.
            ...
            let data = yield this.requestManager.schedule(request, 1);
            let $ = this.cheerio.load(data.data);
            let manga = this.parser.parseHomeSection($, this).filter(manga => { var _a, _b; return manga.title.text.toLowerCase().includes((_b = (_a = query.title) === null || _a === void 0 ? void 0 : _a.toLowerCase()) !== null && _b !== void 0 ? _b : ''); });
            let mData = { page: (page + 1) };
            if (this.parser.isLastPage($)) {
                mData = undefined;
            }
...
exports.GenkanLegacy = GenkanLegacy;

},{"./Genkan":28}],30:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"paperback-extensions-common":4}],31:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.HatigarmScans = exports.HatigarmScansInfo = void 0;
const paperback_extensions_common_1 = require("paperback-extensions-common");
const GenkanLegacy_1 = require("../GenkanLegacy");
const HATIGARMSCANS_DOMAIN = "https://hatigarmscanz.net";
exports.HatigarmScansInfo = {
    version: '1.0.0',
    name: 'HatigarmScans',
...
class HatigarmScans extends GenkanLegacy_1.GenkanLegacy {
    constructor() {
        super(...arguments);
        this.baseUrl = HATIGARMSCANS_DOMAIN;
        this.languageCode = paperback_extensions_common_1.LanguageCode.ENGLISH;
    }
}
exports.HatigarmScans = HatigarmScans;

},{"../GenkanLegacy":29,"paperback-extensions-common":4}]},{},[31])(31)
});
